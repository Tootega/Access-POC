...
namespace TFX.App.Core.INF.Perfil
{
    ...
    public class PerfilDireitoService : XService, IPerfilDireitoService
    {
        ...
        public PerfilDireitoDataSet Select(PerfilDireitoRequest pRequest, Boolean pFull)
        {
            ...
            var dst = query.Select(q => new PerfilDireitoTuple(){CORxPerfilID = q.CORxPerfilDireiro.CORxPerfilID,
                                     ...
                                     CORxRecursoDireitoID = q.CORxPerfilDireiro.CORxRecursoDireitoID});
